...
import type { BackgroundEffectProps, MassageLabRetroGridOptions } from "./css-backgrounds"
...
} satisfies Required<MassageLabRetroGridOptions>
...
export default function MassageLabRetroGridBackground({
  ...
  return (
    <div
      ref={containerRef}
      className={cn(styles.effectLayer, styles.massageLabRetroGridBackground, className)}
      style={wrapperStyle}
      aria-hidden="true"
    >
      <canvas ref={canvasRef} className={styles.massageLabRetroGridCanvas} />
      {!isWebGlReady ? (
