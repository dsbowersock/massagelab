...
// Unlumen UI Aurora Bars adapted as an internal MassageLab premium effect.
// Music can opt into a visualizer mode; Clock and Chimer use the passive source motion.
export default function UnlumenAuroraBarsBackground({
  auroraBars,
  className,
  ...
  return (
    <div
      ref={containerRef}
      aria-hidden="true"
      className={cn(styles.effectLayer, styles.unlumenAuroraBars, className)}
...
function createMonochromaticPalette(primaryColor: string) {
  ...
  // Auto mode keeps one hue family and changes brightness only, matching the Unlumen bar gradient shape.
  return [
