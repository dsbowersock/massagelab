...
// Aceternity UI Wavy Background by Manu Arora, adapted as an internal MassageLab premium visual effect.
export default function AceternityWavyBackground({ className, wavy }: BackgroundEffectProps) {
  ...
  return (
    <div
      className={cn(styles.effectLayer, styles.aceternityWavyBackground, className)}
