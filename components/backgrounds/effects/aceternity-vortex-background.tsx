...
// Aceternity UI Vortex by Manu Arora, adapted as an internal MassageLab premium visual effect.
export default function AceternityVortexBackground({ className, vortex }: BackgroundEffectProps) {
  ...
  return (
    <div className={cn(styles.effectLayer, styles.aceternityVortexBackground, className)} aria-hidden="true">
