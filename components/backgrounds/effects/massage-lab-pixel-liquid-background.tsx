...
export default function MassageLabPixelLiquidBackground({ className, pixelLiquid }: BackgroundEffectProps) {
  ...
  return (
    <div className={cn(styles.massageLabPixelLiquid, className)}>
