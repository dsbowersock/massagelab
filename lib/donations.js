...
export const DONATION_OPTIONS = Object.freeze([
  ...
  Object.freeze({
    amountCents: 1500,
    label: "$15",
    description: "Fund a careful build session",
  }),
  Object.freeze({
    amountCents: 3000,
    label: "$30",
    description: "Help with infrastructure costs",
  }),
  Object.freeze({
    amountCents: 7500,
    label: "$75",
...
/**
 * Donations are intentionally fixed-amount one-time payments so the billing
