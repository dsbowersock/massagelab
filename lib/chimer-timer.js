...
export const CHIMER_BACKGROUND_SOURCE_COLOR_DEFAULTS = Object.freeze(Object.fromEntries(
  LEGACY_BACKGROUND_COLOR_SETTING_KEYS.map((key) => [
    key,
    CHIMER_SETTINGS_WITH_RENDERER_SOURCE_DEFAULTS[key],
  ]),
))
