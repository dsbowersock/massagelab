...
export function sanitizeChimerSettings(input = {}) {
  ...
  const sanitizedSettings = {
    ...
    aceternity3DGlobeScale: normalizeNumber(input.aceternity3DGlobeScale, fallback.aceternity3DGlobeScale, 0.34, 0.84),
    ...
    aceternity3DGlobeMarkerLabel: normalizeShortString(
      input.aceternity3DGlobeMarkerLabel,
      fallback.aceternity3DGlobeMarkerLabel,
      80,
    ),
    aceternity3DGlobeMarkerAvatarUrl: normalizeHttpUrl(
      input.aceternity3DGlobeMarkerAvatarUrl,
      fallback.aceternity3DGlobeMarkerAvatarUrl,
    ),
...
export function sanitizeChimerSettingsForEntitlements(input = {}, features = []) {
  ...
  const sanitizedSettings = {
    ...
    ...(!canUsePremiumBackgrounds ? {
      ...
      aceternity3DGlobeMarkerAvatarUrl: DEFAULT_CHIMER_SETTINGS.aceternity3DGlobeMarkerAvatarUrl,
