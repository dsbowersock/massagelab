...
import { DEFAULT_DNA_CHIMER_SETTINGS, DNA_OPTION_BOUNDS } from "./dna-background.js"
import {
...
export function sanitizeChimerSettings(input = {}, options = {}) {
  ...
  const sanitizedSettings = {
    ...
    massageLabDnaStrandCount: normalizeInteger(input.massageLabDnaStrandCount, fallback.massageLabDnaStrandCount, DNA_OPTION_BOUNDS.strandCount.minimum, DNA_OPTION_BOUNDS.strandCount.maximum),
    massageLabDnaShowBaseLetters: typeof input.massageLabDnaShowBaseLetters === "boolean"
      ? input.massageLabDnaShowBaseLetters
      : fallback.massageLabDnaShowBaseLetters,
    massageLabDnaNodeMotionSpeed: normalizeNumber(input.massageLabDnaNodeMotionSpeed, fallback.massageLabDnaNodeMotionSpeed, DNA_OPTION_BOUNDS.nodeMotionSpeed.minimum, DNA_OPTION_BOUNDS.nodeMotionSpeed.maximum),
    massageLabDnaStrandRotationSpeed: normalizeNumber(input.massageLabDnaStrandRotationSpeed, fallback.massageLabDnaStrandRotationSpeed, DNA_OPTION_BOUNDS.strandRotationSpeed.minimum, DNA_OPTION_BOUNDS.strandRotationSpeed.maximum),
    massageLabDnaStrandAngle: normalizeNumber(input.massageLabDnaStrandAngle, fallback.massageLabDnaStrandAngle, DNA_OPTION_BOUNDS.strandAngle.minimum, DNA_OPTION_BOUNDS.strandAngle.maximum),
    massageLabDnaScale: normalizeNumber(input.massageLabDnaScale, fallback.massageLabDnaScale, DNA_OPTION_BOUNDS.scale.minimum, DNA_OPTION_BOUNDS.scale.maximum),
    massageLabDnaPositionX: normalizeNumber(input.massageLabDnaPositionX, fallback.massageLabDnaPositionX, DNA_OPTION_BOUNDS.positionX.minimum, DNA_OPTION_BOUNDS.positionX.maximum),
    massageLabDnaPositionY: normalizeNumber(input.massageLabDnaPositionY, fallback.massageLabDnaPositionY, DNA_OPTION_BOUNDS.positionY.minimum, DNA_OPTION_BOUNDS.positionY.maximum),
    massageLabDnaStrandSpacing: normalizeNumber(input.massageLabDnaStrandSpacing, fallback.massageLabDnaStrandSpacing, DNA_OPTION_BOUNDS.strandSpacing.minimum, DNA_OPTION_BOUNDS.strandSpacing.maximum),
    massageLabDnaConnectorWidth: normalizeNumber(input.massageLabDnaConnectorWidth, fallback.massageLabDnaConnectorWidth, DNA_OPTION_BOUNDS.connectorWidth.minimum, DNA_OPTION_BOUNDS.connectorWidth.maximum),
    massageLabDnaConnectorThickness: normalizeNumber(input.massageLabDnaConnectorThickness, fallback.massageLabDnaConnectorThickness, DNA_OPTION_BOUNDS.connectorThickness.minimum, DNA_OPTION_BOUNDS.connectorThickness.maximum),
    massageLabDnaOutlineThickness: normalizeNumber(input.massageLabDnaOutlineThickness, fallback.massageLabDnaOutlineThickness, DNA_OPTION_BOUNDS.outlineThickness.minimum, DNA_OPTION_BOUNDS.outlineThickness.maximum),
    massageLabTwistedCubesLayerCount: normalizeInteger(input.massageLabTwistedCubesLayerCount, fallback.massageLabTwistedCubesLayerCount, TWISTED_CUBES_OPTION_BOUNDS.layerCount.minimum, TWISTED_CUBES_OPTION_BOUNDS.layerCount.maximum),
    massageLabTwistedCubesRotationSpeed: normalizeNumber(input.massageLabTwistedCubesRotationSpeed, fallback.massageLabTwistedCubesRotationSpeed, TWISTED_CUBES_OPTION_BOUNDS.rotationSpeed.minimum, TWISTED_CUBES_OPTION_BOUNDS.rotationSpeed.maximum),
    massageLabTwistedCubesLayerStagger: normalizeNumber(input.massageLabTwistedCubesLayerStagger, fallback.massageLabTwistedCubesLayerStagger, TWISTED_CUBES_OPTION_BOUNDS.layerStagger.minimum, TWISTED_CUBES_OPTION_BOUNDS.layerStagger.maximum),
    massageLabTwistedCubesViewAngleX: normalizeNumber(input.massageLabTwistedCubesViewAngleX, fallback.massageLabTwistedCubesViewAngleX, TWISTED_CUBES_OPTION_BOUNDS.viewAngleX.minimum, TWISTED_CUBES_OPTION_BOUNDS.viewAngleX.maximum),
    massageLabTwistedCubesViewAngleY: normalizeNumber(input.massageLabTwistedCubesViewAngleY, fallback.massageLabTwistedCubesViewAngleY, TWISTED_CUBES_OPTION_BOUNDS.viewAngleY.minimum, TWISTED_CUBES_OPTION_BOUNDS.viewAngleY.maximum),
    massageLabTwistedCubesScale: normalizeNumber(input.massageLabTwistedCubesScale, fallback.massageLabTwistedCubesScale, TWISTED_CUBES_OPTION_BOUNDS.scale.minimum, TWISTED_CUBES_OPTION_BOUNDS.scale.maximum),
    massageLabTwistedCubesPositionX: normalizeNumber(input.massageLabTwistedCubesPositionX, fallback.massageLabTwistedCubesPositionX, TWISTED_CUBES_OPTION_BOUNDS.positionX.minimum, TWISTED_CUBES_OPTION_BOUNDS.positionX.maximum),
    massageLabTwistedCubesPositionY: normalizeNumber(input.massageLabTwistedCubesPositionY, fallback.massageLabTwistedCubesPositionY, TWISTED_CUBES_OPTION_BOUNDS.positionY.minimum, TWISTED_CUBES_OPTION_BOUNDS.positionY.maximum),
    massageLabTwistedCubesLayerDepthSpacing: normalizeNumber(input.massageLabTwistedCubesLayerDepthSpacing, fallback.massageLabTwistedCubesLayerDepthSpacing, TWISTED_CUBES_OPTION_BOUNDS.layerDepthSpacing.minimum, TWISTED_CUBES_OPTION_BOUNDS.layerDepthSpacing.maximum),
    massageLabTwistedCubesOpacityFalloff: normalizeNumber(input.massageLabTwistedCubesOpacityFalloff, fallback.massageLabTwistedCubesOpacityFalloff, TWISTED_CUBES_OPTION_BOUNDS.opacityFalloff.minimum, TWISTED_CUBES_OPTION_BOUNDS.opacityFalloff.maximum),
    massageLabTwistedCubesOutlineThickness: normalizeNumber(input.massageLabTwistedCubesOutlineThickness, fallback.massageLabTwistedCubesOutlineThickness, TWISTED_CUBES_OPTION_BOUNDS.outlineThickness.minimum, TWISTED_CUBES_OPTION_BOUNDS.outlineThickness.maximum),
...
export function sanitizeChimerSettingsForEntitlements(
  ...
  const sanitizedSettings = {
    ...
    ...(!canUsePremiumBackgrounds ? {
      ...
      massageLabDnaShowBaseLetters: DEFAULT_CHIMER_SETTINGS.massageLabDnaShowBaseLetters,
