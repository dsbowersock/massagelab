...
export function sanitizeChimerSettings(input = {}, options = {}) {
  ...
  const sanitizedSettings = {
    ...
    massageLabDnaStrandCount: normalizeInteger(input.massageLabDnaStrandCount, fallback.massageLabDnaStrandCount, 7, 81),
    ...
    massageLabDnaNodeMotionSpeed: normalizeNumber(input.massageLabDnaNodeMotionSpeed, fallback.massageLabDnaNodeMotionSpeed, 0.01, 3),
    massageLabDnaStrandRotationSpeed: normalizeNumber(input.massageLabDnaStrandRotationSpeed, fallback.massageLabDnaStrandRotationSpeed, 0.01, 3),
    ...
    massageLabTwistedCubesRotationSpeed: normalizeNumber(input.massageLabTwistedCubesRotationSpeed, fallback.massageLabTwistedCubesRotationSpeed, 0.01, 3),
    ...
    massageLabTwistedCubesScale: normalizeNumber(input.massageLabTwistedCubesScale, fallback.massageLabTwistedCubesScale, 0.1, 1.2),
