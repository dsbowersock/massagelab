  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        id: "activity",
        label: "Activity",
        description: "A private record of account changes and support updates.",
        icon: "FileCheck2",
        status: "current",
        statusLabel: "Account history",
        sections: ["account-activity"],
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        description: "Current Supporter benefits, pricing, subscription status, and billing account access.",
        icon: "CreditCard",
        status: "current",
        statusLabel: "Billing",
