import { normalizePublishedPreviewCustomDomainBaseUrl } from "./background-preview-catalog-base-url.js"
...
function normalizePublishedPreviewCatalogBaseUrl(value) {
  ...
  return normalizePublishedPreviewCustomDomainBaseUrl(trimmed)
}
