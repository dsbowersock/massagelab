 ...
 * deliberately does not stamp, push, or replace Next.js history state. A null
 * result means the caller must omit directionless `popstate` interception;
 * guessing a restore delta can trap navigation or truncate Forward history.
 *
 * @param {{
