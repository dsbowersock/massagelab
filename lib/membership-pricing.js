...
export const MEMBERSHIP_PLAN_DETAILS = Object.freeze({
  SUPPORTER: {
    ...
    description: "For users who want the current Chimer color upgrade and want to help keep MassageLab development moving.",
    currentFeatures: [
    ...
    roadmapNotes: [
      "Helps fund development and compliance groundwork for future clinical tools.",
    ],
  },
  THERAPIST: {
    name: "Therapist",
    ...
    roadmapNotes: [
      "Helps fund therapist documentation features like local transcription experiments and SOAP drafting support.",
  ...
  PRACTICE: {
    ...
    description: "For teams or practices that want shared scheduling workflows and managed sync once compliance work is ready.",
    currentFeatures: [
    ...
    roadmapNotes: [
      ...
      "Helps fund future managed sync, BAAs, audit controls, and practice-ready documentation infrastructure.",
    ],
  },
})
