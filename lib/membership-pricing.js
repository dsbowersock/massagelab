 ...
 * failed/malformed configured projections remain retryable short-TTL results.
 */
 ...
 * interval. Clearing advances the generation so a stale provider completion
 * cannot replace a newer catalog.
 *
 * @param {{
