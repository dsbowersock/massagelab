...
export const supporterRoadmapInterestOptions = Object.freeze([
  { id: "personal_wellness", label: "Personal wellness" },
  { id: "backgrounds_and_sound", label: "Backgrounds and sound" },
  { id: "therapist_tools", label: "Therapist tools" },
  { id: "practice_management", label: "Practice management" },
  { id: "anatomy_and_education", label: "Anatomy and education" },
  { id: "professional_documentation", label: "Professional documentation" },
])
