...
const defaultHomeToolsByRole = {
  therapist: ["local_notes", "calendar_booking", "anatomime", "education_flashcards", "chimer", "account_memberships", "roadmap_support"],
  student: ["education_flashcards", "anatomime", "chimer", "account_memberships", "calendar_booking", "roadmap_support"],
  educator: ["anatomime", "education_flashcards", "chimer", "account_memberships", "calendar_booking", "roadmap_support"],
  client: ["calendar_booking", "chimer", "education_flashcards", "local_notes", "account_memberships", "roadmap_support"],
  public_wellness: ["education_flashcards", "anatomime", "chimer", "calendar_booking", "local_notes", "roadmap_support", "account_memberships"],
}
const roleHintSignalByUseCase = {
  learn_anatomy: ["education_flashcards", "anatomime"],
  teach_anatomy: ["anatomime", "education_flashcards"],
  run_sessions: ["chimer", "anatomime"],
  manage_practice: ["calendar_booking", "account_memberships"],
  book_care: ["calendar_booking", "local_notes"],
  track_progress: ["education_flashcards", "chimer"],
}
