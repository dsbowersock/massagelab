...
const defaultHomeToolsByRole = {
  therapist: ["local_notes", "calendar_booking", "anatomime", "education_flashcards", "chimer", "account_memberships"],
  ...
  public_wellness: ["education_flashcards", "anatomime", "chimer", "calendar_booking", "local_notes", "roadmap_support"],
}
