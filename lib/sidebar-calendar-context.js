...
/**
 * Account ids are opaque cache/database keys. Reject surrounding whitespace
 * rather than silently remapping a session to a different owner key.
 *
 * @param {unknown} value
 * @returns {value is string}
 */
export function isCanonicalSidebarCalendarOwnerId(value) {
...
export async function getSidebarCalendarContext(userId) {
  if (!isCanonicalSidebarCalendarOwnerId(userId)) {
    return emptySidebarCalendarContext
  }
