...
export const LEGAL_DOCUMENT_VERSION = "2026-06-legal-v2"
export const DIGITAL_PURCHASES_REFUNDS_VERSION = "2026-07-digital-purchases-v1"
...
const sharedNotices = Object.freeze([
  "MassageLab is an early-access project. These documents describe the current product posture and may change as the service develops.",
    ...
    sections: [
      {
        ...
        body: [
          `${LEGAL_BUSINESS_IDENTITY}, provides MassageLab as an early-access software platform for education, timing, scheduling, memberships, wellness self-tracking, and local-first professional documentation tools.`,
          ...sharedNotices,
        ],
      },
      {
      ...
      },
      {
        ...
        body: [
          "Detailed dispute, venue, arbitration, or class-action terms may be added as MassageLab's public release matures.",
        ],
      },
    ],
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          "MassageLab does not sell user data and does not use advertising, ad targeting, marketing retargeting, or ad personalization to fund the project.",
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          "MassageLab may offer optional one-time support payments for users who want to help fund the project without starting a subscription.",
    ...
    sections: [
      {
        ...
        body: [
          "Each named digital background is delivered to the purchasing MassageLab account immediately after successful payment and fulfillment.",
      ...
      },
      {
        ...
        body: [
          "Individual digital-background purchases are final except where applicable law requires otherwise or MassageLab approves a documented exception.",
          "A failed delivery, duplicate charge, materially misdescribed item, or other legally required remedy may be reviewed through MassageLab support.",
        ],
      },
      {
