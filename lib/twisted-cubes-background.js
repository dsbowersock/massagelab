...
// Maps the source's large vmin depth range into a subtle centered projection
// that preserves the approved no-perspective wireframe composition.
export const TWISTED_CUBES_DEPTH_PROJECTION_DIVISOR = 10000
