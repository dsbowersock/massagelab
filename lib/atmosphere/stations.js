...
const atmosphereStations = Object.freeze([
  ...
  },
  {
    ...
    enabled: true,
    description:
      "A MassageLab-hosted Generative.fm station using Alex Bainter's Observable Streams piece with a CC0 VSCO sample adaptation.",
    tags: ["Generative.fm", "acoustic", "sample-hosted", "VSCO adaptation"],
    attribution: {
      artist: "Alex Bainter",
      license: "MIT",
