...
const OBSERVABLE_STREAMS_ADAPTATION_ID = "observable-streams-vsco-adaptation"
const OBSERVABLE_STREAMS_SAMPLE_BASE_PATH =
  "/audio/atmosphere/observable-streams-vsco-adaptation/samples"
const OBSERVABLE_STREAMS_SAMPLE_INDEX_PATH =
...
const atmosphereStations = Object.freeze([
  ...
  },
  {
    ...
    runtime: {
      ...
      sampleIndexPath: OBSERVABLE_STREAMS_SAMPLE_INDEX_PATH,
      sampleBasePath: OBSERVABLE_STREAMS_SAMPLE_BASE_PATH,
