...
import {
  ...
  GENERATIVE_FM_REMAINING_GENERATOR_SAMPLE_GROUPS,
  GENERATIVE_FM_SOURCE_INDEX_ROLLOUT_SAMPLE_GROUPS,
...
export const DEFAULT_GENERATIVE_FM_RENDER_PLAN_PIECE_IDS = Object.freeze([
  ...
  "transmission",
  "trees",
  ...Object.keys(GENERATIVE_FM_SOURCE_INDEX_ROLLOUT_SAMPLE_GROUPS),
  ...Object.keys(GENERATIVE_FM_REMAINING_GENERATOR_SAMPLE_GROUPS),
])

const GENERATIVE_FM_SOURCE_INDEX_ROLLOUT_BATCH = Object.freeze(
  Object.entries(GENERATIVE_FM_SOURCE_INDEX_ROLLOUT_SAMPLE_GROUPS).map(([pieceId, sourceInstrumentNames]) =>
    Object.freeze({ pieceId, sourceInstrumentNames }),
  ),
)
const GENERATIVE_FM_REMAINING_GENERATOR_BATCH = Object.freeze(
  Object.entries(GENERATIVE_FM_REMAINING_GENERATOR_SAMPLE_GROUPS).map(([pieceId, sourceInstrumentNames]) =>
    Object.freeze({ pieceId, sourceInstrumentNames }),
  ),
)
...
const GENERATIVE_FM_RENDER_PLAN_BATCH = Object.freeze([
  ...
  ...GENERATIVE_FM_REMAINING_GENERATOR_BATCH.map(sourceIndexRolloutPiece),
])
