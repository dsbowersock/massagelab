...
const GENERATIVE_FM_SOURCE_INDEX_ROLLOUT_BATCH = Object.freeze([
  Object.freeze({
    pieceId: "420hz-gamma-waves-for-big-brain",
    sourceInstrumentNames: Object.freeze(["waves", "vsco2-piano-mf", "sso-chorus-male"]),
  }),
  Object.freeze({
    pieceId: "a-viable-system",
    sourceInstrumentNames: Object.freeze(["vsco2-piano-mf", "vsco2-contrabass-susvib", "vsco2-violin-arcvib"]),
  }),
  Object.freeze({
    pieceId: "above-the-rain",
    sourceInstrumentNames: Object.freeze(["sso-chorus-female", "vsco2-trumpet-sus-mf"]),
  }),
  Object.freeze({
    pieceId: "agua-ravine",
    sourceInstrumentNames: Object.freeze(["vsco2-piano-mf", "vcsl-vibraphone-soft-mallets-mp"]),
  }),
  Object.freeze({
    pieceId: "apoapsis",
    sourceInstrumentNames: Object.freeze(["vsco2-violins-susvib", "vsco2-piano-mf"]),
  }),
  Object.freeze({
    pieceId: "beneath-waves",
    sourceInstrumentNames: Object.freeze(["sso-chorus-female", "sso-cor-anglais"]),
  }),
  Object.freeze({
    pieceId: "bhairav",
    sourceInstrumentNames: Object.freeze(["vsco2-piano-mf", "vsco2-cellos-susvib-mp"]),
  }),
  Object.freeze({
    pieceId: "buttafingers",
    sourceInstrumentNames: Object.freeze(["vcsl-wine-glasses-slow", "vcsl-claves"]),
  }),
  Object.freeze({
    pieceId: "documentary-films",
    sourceInstrumentNames: Object.freeze(["vsco2-trumpet-sus-mf", "vsco2-trombone-sus-mf", "vsco2-tuba-sus-mf"]),
  }),
  Object.freeze({
    pieceId: "drones",
    sourceInstrumentNames: Object.freeze(["vsco2-trumpet-sus-f", "vsco2-trumpet-sus-mf"]),
  }),
  Object.freeze({
    pieceId: "drones-2",
    sourceInstrumentNames: Object.freeze(["vsco2-violins-susvib"]),
  }),
  Object.freeze({
    pieceId: "enough",
    sourceInstrumentNames: Object.freeze(["sso-cor-anglais"]),
  }),
  Object.freeze({
    pieceId: "expand-collapse",
    sourceInstrumentNames: Object.freeze(["vsco2-piano-mf"]),
  }),
  Object.freeze({
    pieceId: "homage",
    sourceInstrumentNames: Object.freeze(["vsco2-piano-mf", "vsco2-violins-susvib"]),
  }),
  Object.freeze({
    pieceId: "nakaii",
    sourceInstrumentNames: Object.freeze(["vsco2-piano-mf", "vsco2-violins-susvib"]),
  ...
  Object.freeze({
    pieceId: "oxalis-1",
    sourceInstrumentNames: Object.freeze(["vsco2-piano-mf", "vsco2-glock"]),
  }),
  Object.freeze({
    pieceId: "remembering",
    sourceInstrumentNames: Object.freeze(["vsco2-piano-mf"]),
  ...
  Object.freeze({
    pieceId: "return-to-form",
    sourceInstrumentNames: Object.freeze(["vsco2-piano-mf"]),
  }),
  Object.freeze({
    pieceId: "ritual",
    sourceInstrumentNames: Object.freeze([
      "vcsl-didgeridoo-sus",
  ...
  Object.freeze({
    pieceId: "soundtrack",
    sourceInstrumentNames: Object.freeze(["vsco2-cellos-susvib-mp", "vsco2-glock"]),
  }),
  Object.freeze({
    pieceId: "splash",
    sourceInstrumentNames: Object.freeze(["vsco2-piano-mf"]),
  ...
  Object.freeze({
    pieceId: "spring-again",
    sourceInstrumentNames: Object.freeze(["vsco2-piano-mf", "vsco2-violins-susvib", "vsco2-cello-susvib-f"]),
  }),
  Object.freeze({
    pieceId: "substrate",
    sourceInstrumentNames: Object.freeze(["vsco2-marimba", "vsco2-piano-mf"]),
  }),
  Object.freeze({
    pieceId: "timbral-oscillations",
    sourceInstrumentNames: Object.freeze(["vsco2-piano-mf"]),
  }),
  Object.freeze({
    pieceId: "yesterday",
    sourceInstrumentNames: Object.freeze(["vcsl-tenor-sax-vib"]),
  }),
])
  ...
  Object.freeze({
    ...
    renderedTargets: Object.freeze([
      Object.freeze({
        ...
        notes: Object.freeze(["A2", "C3", "G3", "G2", "C4", "E4", "G4", "B4", "C5", "E5", "G5", "B5"]),
        pitchShiftSemitones: 0,
        additionalRenderLengthSeconds: 0,
        renderEffect: "Tone Reverb(5).set({ wet: 0.5 })",
        reverb: Object.freeze({ roomSize: 0.5, wet: 0.5 }),
        note:
          "These targets mirror the package's fixed left-hand notes plus toss(C/E/G/B, [4, 5]); duplicate G3 is rendered once.",
      }),
    ]),
    packageEvidence:
      "@generative-music/piece-no-refrain v5.2.2 calls createPrerenderableSampler for no-refrain__vsco2-piano-mf with fixed bass notes and C/E/G/B over octaves 4 and 5.",
  }),
  Object.freeze({
    ...
    renderedTargets: Object.freeze([
      Object.freeze({
        ...
        sourceInstrumentName: "vsco2-piano-mf",
        outputFilePrefix: "rendered-piano",
        notes: Object.freeze(["A1", "C#2", "E2", "G#2", "C4", "E4", "G4", "A#4", "D#5", "G5", "A#5", "D6"]),
        pitchShiftSemitones: 0,
        additionalRenderLengthSeconds: 0,
        renderEffect: "Tone Reverb(15).set({ wet: 0.5 })",
        reverb: Object.freeze({ roomSize: 0.9, wet: 0.5 }),
        note:
          "These targets are the package's sortNotes(C/E/G/B3 transposed by -15/-5/0/5/15/27) list filtered to notes more than two semitones apart.",
      }),
    ]),
    packageEvidence:
      "@generative-music/piece-transmission v5.2.2 creates two prerenderable samplers from one transmission__vsco2-piano-mf rendered note set.",
  }),
  Object.freeze({
    pieceId: "trees",
    strategy: "rendered-notes",
    ...
    renderedTargets: Object.freeze([
      Object.freeze({
        renderedInstrumentName: "trees__vsco2-piano-mf",
        sourceInstrumentName: "vsco2-piano-mf",
        outputFilePrefix: "rendered-piano",
        notes: Object.freeze(["C3", "E3", "G3", "C4", "E4", "G4", "C5", "E5", "G5", "C6", "E6", "G6", "B6"]),
        pitchShiftSemitones: 0,
        additionalRenderLengthSeconds: 0,
        renderEffect: "Tone Freeverb({ roomSize: 0.6 })",
        reverb: Object.freeze({ roomSize: 0.6, wet: 1 }),
        note:
          "These targets mirror toss(C/E/G, [3, 4, 5, 6]) plus the package's extra B6 upper note.",
      }),
    ]),
    packageEvidence:
      "@generative-music/piece-trees v5.2.2 calls createPrerenderableSampler for trees__vsco2-piano-mf with C/E/G across octaves 3-6 plus B6.",
  }),
  ...GENERATIVE_FM_SOURCE_INDEX_ROLLOUT_BATCH.map(sourceIndexRolloutPiece),
])

/**
 * @param {{ pieceId: string, sourceInstrumentNames: readonly string[] }} entry
 */
function sourceIndexRolloutPiece(entry) {
  return Object.freeze({
    pieceId: entry.pieceId,
    strategy: "source-index",
    sourceIndexTargets: Object.freeze(entry.sourceInstrumentNames.map((sourceInstrumentName) => Object.freeze({
      instrumentName: sourceInstrumentName,
      sourceInstrumentName,
      note:
        "This rollout publishes the verified source key that the installed package requests directly or falls back to when a package-specific rendered key is absent.",
    }))),
    renderedTargets: Object.freeze([]),
    packageEvidence:
      `@generative-music/piece-${entry.pieceId} v5.2.2 requests these source-capable sample groups: ${entry.sourceInstrumentNames.join(", ")}.`,
  })
}

/**
 * Builds the current Generative.fm sample-hosting plan from package evidence
 * plus local sample coverage. Source-index stations stay separate from
 * rendered-note stations so upload code can keep package-compatible keys.
 *
 * @param {{
 *   rootPath?: string,
...
export function createGenerativeFmRenderPlan(params = {}) {
  ...
  return {
    ...
    batchId: "source-index-rollout-and-rendered-batches",
