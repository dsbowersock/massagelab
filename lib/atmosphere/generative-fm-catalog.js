...
import {
  ...
  OBSERVABLE_STREAMS_R2_OPUS_MANIFEST_URL,
  OBSERVABLE_STREAMS_R2_OPUS_SAMPLE_INDEX_OBJECT_KEY,
  OBSERVABLE_STREAMS_R2_OPUS_SAMPLE_INDEX_URL,
...
const SOURCE_INDEX_ROLLOUT_HOSTED_PIECES = Object.freeze({
 ...
 * @property {{ opus?: string }=} sampleIndexFormatUrls
 * @property {{ opus?: string }=} manifestFormatUrls
...
const hostedGenerativeFmPieces = Object.freeze({
  "observable-streams": Object.freeze({
    ...
    sampleIndexFormatUrls: Object.freeze({ opus: OBSERVABLE_STREAMS_R2_OPUS_SAMPLE_INDEX_URL }),
    manifestFormatUrls: Object.freeze({ opus: OBSERVABLE_STREAMS_R2_OPUS_MANIFEST_URL }),
  ...
  ...Object.fromEntries(
    Object.entries(SOURCE_INDEX_ROLLOUT_HOSTED_PIECES).map(([pieceId, hostedSampleGroups]) => [
      pieceId,
...
function hostedBatchPiece({ pieceId, hostedSampleGroups, notice = "" }) {
  ...
  return Object.freeze({
    ...
    sampleIndexFormatUrls: Object.freeze({
      opus: `${OBSERVABLE_STREAMS_R2_PUBLIC_BASE_URL}/${opusSampleIndexObjectKey}`,
    }),
    manifestFormatUrls: Object.freeze({
      opus: `${OBSERVABLE_STREAMS_R2_PUBLIC_BASE_URL}/${opusManifestObjectKey}`,
    }),
