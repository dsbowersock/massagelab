...
const hostedGenerativeFmPieces = Object.freeze({
  ...
  "day-dream": hostedBatchPiece({
    ...
    hostedSampleGroups: ["vsco2-piano-mf"],
    notice:
      "Day/Dream by Alex Bainter. MassageLab runs the package with a hosted CC0 VSCO piano sample adaptation.",
  }),
  "eno-machine": hostedBatchPiece({
    pieceId: "eno-machine",
    hostedSampleGroups: ["vsco2-piano-mf"],
    notice:
      "Eno Machine by Alex Bainter. MassageLab runs the package with a hosted CC0 VSCO piano sample adaptation.",
  }),
  impact: hostedBatchPiece({
    pieceId: "impact",
    hostedSampleGroups: ["vsco2-piano-mf"],
    notice:
      "Impact by Alex Bainter. MassageLab runs the package with a hosted CC0 VSCO piano sample adaptation.",
  }),
  lemniscate: hostedBatchPiece({
    pieceId: "lemniscate",
    hostedSampleGroups: ["vsco2-piano-mf"],
    notice:
      "Lemniscate by Alex Bainter. MassageLab runs the package with a hosted CC0 VSCO piano sample adaptation.",
  }),
