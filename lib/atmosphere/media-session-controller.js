...
/** @typedef {{ title: string, artist?: string | null }} StationMetadata */
/** @typedef {{ title: string, artist: string, album: string, artwork: Array<{ src: string, sizes: string, type: string }> }} MediaMetadataInit */
/** @typedef {{ metadata: unknown, playbackState: MediaSessionPlaybackState, setActionHandler: (action: MediaSessionAction, handler: (() => void) | null) => void }} MediaSessionLike */
