...
function normalizeProperties(value, backgroundId, options) { const allowed = visualKeys(backgroundId, options); if (!allowed || !isRecord(value)) return {}; return Object.fromEntries(Object.entries(value).filter(([key]) => allowed.has(key))) }
