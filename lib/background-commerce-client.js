...
function safeReturnPath(value) {
  ...
  // Reject ambiguous URL syntax at the shared auth boundary so an app-local
  // return path cannot be reinterpreted as a scheme or alternate host.
  if (normalized.includes("\\") || normalized.includes(":") || /[\u0000-\u001f\u007f]/.test(normalized)) return "/"
