  ...
  switch (action.type) {
    ...
    case "ownership-reconcile": {
      ...
      return {
        ...
        snapshot: {
          ...snapshot,
          // The preference route proves only active ownership IDs. Remove stale
          // active rows without inventing provenance, but preserve inactive
          // reversal rows so refund/dispute access continues to fail closed.
