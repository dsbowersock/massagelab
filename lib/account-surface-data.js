...
/**
 * Loads the target account's own support-facing explanations. The projection
 * intentionally excludes the internal actor, notes, and delivery metadata.
 *
 * @param {{ prismaClient: AccountPrismaClient, userId: string }} input
 */
...
export function createAccountSurfaceDataLoader({
  ...
  const cacheableSurfaceLoaders = new Map([
    ...
    ["activity", (input) => loadActivitySurface(input)],
