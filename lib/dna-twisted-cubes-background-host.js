 ...
 * @returns {{
 *   massageLabDna: import("../components/backgrounds/effects/css-backgrounds").MassageLabDnaHostOptions,
 *   massageLabTwistedCubes: import("../components/backgrounds/effects/css-backgrounds").MassageLabTwistedCubesHostOptions,
 * }}
 */
export function resolveDnaTwistedCubesBackgroundHostProps({ settings, category } = {}) {
  if (!SUPPORTED_BACKGROUND_HOST_CATEGORIES.has(category)) {
    throw new TypeError(`Unsupported BackgroundHost category: ${String(category)}`)
  }
