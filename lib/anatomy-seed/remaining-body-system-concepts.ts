...
const CONCEPTS: ConceptSpec[] = [
  ...
  { id: "concept-eye", slug: "eye", name: "Eye", conceptType: "system_structure", bodySystem: "sensory", description: "The eye is the special-sense organ for vision. It is included as a high-level structure concept rather than a detailed ophthalmic anatomy model.", sourceRef: PHYSIOLOGY_SOURCE, locator: LOCATOR },
  { id: "concept-ear", slug: "ear", name: "Ear", conceptType: "system_structure", bodySystem: "sensory", description: "The ear is the special-sense organ region associated with hearing and vestibular function. It supports broad sensory-system coverage.", sourceRef: PHYSIOLOGY_SOURCE, locator: LOCATOR },
  { id: "concept-olfactory-receptor", slug: "olfactory-receptor", name: "Olfactory Receptor", conceptType: "system_structure", bodySystem: "sensory", description: "An olfactory receptor detects odor-related stimuli. It gives smell a structural anchor in the sensory-system concept set.", sourceRef: PHYSIOLOGY_SOURCE, locator: LOCATOR },
  { id: "concept-taste-receptor", slug: "taste-receptor", name: "Taste Receptor", conceptType: "system_structure", bodySystem: "sensory", description: "A taste receptor detects chemical stimuli associated with taste. It provides a structure concept for gustatory education.", sourceRef: PHYSIOLOGY_SOURCE, locator: LOCATOR, terms: [{ term: "gustatory receptor", termType: "clinical" }] },
  { id: "concept-vestibular-apparatus", slug: "vestibular-apparatus", name: "Vestibular Apparatus", conceptType: "system_structure", bodySystem: "sensory", description: "The vestibular apparatus is an inner-ear structure group involved in balance and spatial orientation. It supports movement and balance education at a high level.", sourceRef: PHYSIOLOGY_SOURCE, locator: LOCATOR },
  { id: "concept-vision", slug: "vision", name: "Vision", conceptType: "system_function", bodySystem: "sensory", description: "Vision is the sensory function of detecting and interpreting light-related information. It is represented as a special-sense function for exam-aligned A&P breadth.", sourceRef: PHYSIOLOGY_SOURCE, locator: LOCATOR },
  { id: "concept-hearing", slug: "hearing", name: "Hearing", conceptType: "system_function", bodySystem: "sensory", description: "Hearing is the sensory function of detecting sound. It is modeled as broad A&P content rather than a detailed auditory pathway atlas.", sourceRef: PHYSIOLOGY_SOURCE, locator: LOCATOR },
  { id: "concept-smell", slug: "smell", name: "Smell", conceptType: "system_function", bodySystem: "sensory", description: "Smell is the sensory function associated with detecting odor-related chemicals. It is included for special-senses completeness.", sourceRef: PHYSIOLOGY_SOURCE, locator: LOCATOR, terms: [{ term: "olfaction", termType: "clinical" }] },
  { id: "concept-taste", slug: "taste", name: "Taste", conceptType: "system_function", bodySystem: "sensory", description: "Taste is the sensory function associated with detecting chemicals in food and fluid. It is represented as a special-sense function for introductory A&P coverage.", sourceRef: PHYSIOLOGY_SOURCE, locator: LOCATOR, terms: [{ term: "gustation", termType: "clinical" }] },
  { id: "concept-nociception", slug: "nociception", name: "Nociception", conceptType: "system_function", bodySystem: "sensory", description: "Nociception is nervous-system detection of potentially harmful stimuli. MassageLab uses the concept carefully for education and SOAP language, not pain diagnosis.", sourceRef: PHYSIOLOGY_SOURCE, locator: LOCATOR, terms: [{ term: "pain signaling", termType: "common" }] },
