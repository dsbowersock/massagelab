...
export function doesChimerPreferenceWriteResponseMatch(
  ...
  const submittedSettings = sanitizeChimerSettings(
    objectOrEmpty(requestPayload.chimerSettings),
    normalizationOptions,
  )
  const persistedSettings = sanitizeChimerSettings(
    objectOrEmpty(responseBody.chimerSettings),
    normalizationOptions,
  )
  return JSON.stringify(submittedSettings) === JSON.stringify(persistedSettings)
}
