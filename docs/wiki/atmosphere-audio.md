...
- Playback dispatches `massagelab:atmosphere-startup-timing` with station, piece, prewarm-use, and phase timing details. Console logging is opt-in with `localStorage.setItem("massagelab:atmosphere:debug", "1")`.
