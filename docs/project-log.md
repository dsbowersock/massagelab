...
- Database status: Prisma schema validates; the repo has 26 migrations, and `npm run prisma:migrate:deploy` has applied the flashcard deck, flashcard mastery, anatomy media review, anatomy media review default/backfill, `20260612110000_anatomy_media_view_requests`, and `20260613160000_anatomime_shared_sessions` migrations to the configured Neon/Postgres database.
