...
- Expanded Anatomime setup to all sourced anatomy study categories/regions with configurable deck size, difficulty, typed or multiple-choice shared answers, host lobby controls, player join/play routes, and polling fallback when realtime is unavailable.
