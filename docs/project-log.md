...
- Database status: Prisma schema validates; the repo has 30 migrations, including the Anatomime room/game-run migration, flashcard-compatible Anatomime progress uniqueness migration, and client wellness foundation migration.
