...
- Database status: Prisma schema validates; the repo has 29 migrations, including the Anatomime room/game-run migration and flashcard-compatible Anatomime progress uniqueness migration.
