...
| Open | P2 | Functional/visual product surface work | [Project state](project-state.md), [Roadmap](roadmap.md) | Prefer the next branch to improve a visible, usable part of the product instead of returning immediately to transcription feasibility, hosted PHI, or backend compliance work. Shared Anatomime classroom-session polish, media review queue filters, anatomy flashcards/study UI hardening, or trust/public identity pages are good branch-sized candidates. |
