...
- **Collision notes:** Falling white blocks keep it separate from Pixel Scatter's assembled shapes, Meteors' streaks, and Particle Drift's points.
...
- **Collision notes:** Its bright central wave contrasts with Grid Bloom's purple interference mesh and Grid Scan's receding tunnel.
...
- **Collision notes:** The regular purple rows contrast with Dot Field's ambient bends, Pinpoint Shimmer's microglow, and Speckled Veil's dense matrix.
