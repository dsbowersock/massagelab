...
- **Decision:** rename
- **Alternatives:** Wishlight Sky; Starlight Passage
- **Visual descriptor:** Sparse stars twinkling between occasional bright streaks
- **Signature original eligible:** No
- **Rationale:** Shooting Stars is worth retaining with consistent title casing because the occasional bright transit is the scene's defining event.
- **Collision notes:** Event frequency separates it from Meteors' continual diagonal field, Star Lattice's ordered points, and Drifting Starfield's layers.
