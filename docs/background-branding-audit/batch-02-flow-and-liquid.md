...
- **Collision notes:** Judge its broad liquid cells against Line Current's fine contours and Ribbon Tide's blurred bands, not against the similarly named legacy entry.
...
- **Collision notes:** The light ground and many narrow parallel paths distinguish it from Filament Waves, Floating Lines, and the blue Tidal Glass shader.
...
- **Collision notes:** Its few broad luminous ribbons contrast with Floating Lines' layered arcs and Line Current's dense monochrome contours.
...
- **Collision notes:** The monochrome textile surface separates Silk from Iridescence's pearly color wash and Prismatic Ribbons' discrete spectrum bands.
...
- **Collision notes:** Layered violet arcs distinguish this renderer from the single fine Threads field and Filament Waves' dense white bundle.
...
- **Collision notes:** Density is the key separator from Threads' sparse strands, Line Current's evenly spaced contours, and Floating Lines' colored bands.
...
- **Collision notes:** Use the sparse thread count to keep this title distinct from Filament Waves' thick bundle and Line Current's ordered sheet.
...
- **Collision notes:** The continuous bending ribbons differ from Prismatic Burst's radial rays, Prism's triangle, and Iridescence's blended wash.
...
- **Collision notes:** Its diffuse violet fluid behavior is separate from Molten Mirror's reflective spiral and Ferrofluid's outlined cellular contours.
...
- **Collision notes:** Reserve this name for the black-and-white spiral; Chrome Marbling describes the broader grey flow shader in Batch 6.

## Ferrofluid
- **ID:** `massage-lab-ferrofluid`
- **Current name:** Ferrofluid
- **Decision:** keep
- **Alternatives:** Magnetic Bloom; Fluid Filaments
- **Visual descriptor:** Glowing liquid contours clustering and separating
- **Signature original eligible:** No
- **Rationale:** Ferrofluid is a precise, pronounceable material reference for the rim-lit cellular forms and preserves a strong source name without a medical implication.
- **Collision notes:** Outlined droplet contours distinguish it from Liquid Ether's cloudy plumes, Plasma's rounded cells, and the mirrorlike chrome effects.
...
- **Collision notes:** Its blended pearly surface is distinct from Silk's silver folds, Pastel Drift's grainy bands, and Aurora Wash's vertical curtains.
