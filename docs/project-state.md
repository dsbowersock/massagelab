...
- Latest migration area: flashcard study session timing for mastery-progress summaries.
...
- P2: Prefer upcoming branches to continue functional/visual product work rather than backend or compliance-heavy expansion; richer Anatomime learning surfaces, flashcard UX hardening, or trust/public identity pages are better fits for the next work session.
