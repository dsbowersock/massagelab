...
- Migration count at last verification: 24 migrations.
- Latest migration area: anatomy media entity review status, reason, priority, reviewer metadata, needs-review default, and needs-review backfill for item-image curation.
