...
describe("Anatomy admin browser table UI", () => {
  ...
  it("adds a mobile-first image review queue backed by link review state", async () => {
    ...
    assert.match(pageSource, /function AnatomyAdminDashboard/)
    assert.match(pageSource, /Review images/)
    assert.match(pageSource, /mediaLinksNeedingReview/)
    assert.match(pageSource, /href="\/admin\/anatomy\/media-review"/)
