...
describe("Anatomy admin browser table UI", () => {
  ...
  it("surfaces visual media review, candidate approval, and BodyParts3D import controls", async () => {
    ...
    assert.match(pageSource, /Open BodyParts3D source view/)
    ...
    assert.match(importFieldsSource, /Open selected view/)
    assert.match(importFieldsSource, /Copy selected URL/)
