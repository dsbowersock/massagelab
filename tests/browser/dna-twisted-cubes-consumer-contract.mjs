 ...
 * consumer. `target` and `properties` are report descriptions only; executable
...
export const COMPUTED_CONSUMER_CONTRACTS = Object.freeze([
  ...
  { effectId: "massage-lab-dna", label: "Node size", key: "massageLabDnaNodeSize", target: "strand > [data-side]", properties: ["width", "height", "transform"], allowedRenderChanges: ["nodeSize"], allowedCouplings: ["startNodeWidth", "startNodeHeight", "endNodeWidth", "endNodeHeight", "startNodeTransform", "endNodeTransform"] },
  ...
  { effectId: "massage-lab-twisted-cubes", label: "View angle X", key: "massageLabTwistedCubesViewAngleX", target: ".layer > .view", properties: ["transform"], allowedRenderChanges: ["viewAngleX"], allowedCouplings: ["viewTransform", "secondViewTransform"] },
  { effectId: "massage-lab-twisted-cubes", label: "View angle Y", key: "massageLabTwistedCubesViewAngleY", target: ".layer > .view", properties: ["transform"], allowedRenderChanges: ["viewAngleY"], allowedCouplings: ["viewTransform", "secondViewTransform"] },
  { effectId: "massage-lab-twisted-cubes", label: "Layer count", key: "massageLabTwistedCubesLayerCount", target: "[style*='--ml-twisted-cubes-outline'] > .view > .cube > .cuboid > .edge", properties: ["count", "depth", "size", "animationDelay", "transform", "opacity"], allowedRenderChanges: ["layerCount", "middleOutline", "firstAlpha", "firstDelay", "firstSize", "secondDepth"], allowedCouplings: ["layerCount", "edgeCount", "viewTransform", "secondViewTransform", "cubeTransform", "cubeDelay", "edgeWidth", "edgeHeight", "edgeOpacity"] },
  { effectId: "massage-lab-twisted-cubes", label: "Layer depth", key: "massageLabTwistedCubesLayerDepthSpacing", target: ".layer > .view", properties: ["transform", "projectedSize"], allowedRenderChanges: ["secondDepth"], allowedCouplings: ["viewTransform", "secondViewTransform", "edgeRenderedWidth"] },
  { effectId: "massage-lab-twisted-cubes", label: "Scale", key: "massageLabTwistedCubesScale", target: "cube wireframe edges", properties: ["size", "transform"], allowedRenderChanges: ["firstSize"], allowedCouplings: ["cubeTransform", "edgeWidth", "edgeHeight"] },
  ...
  { effectId: "massage-lab-twisted-cubes", label: "Fade falloff", key: "massageLabTwistedCubesOpacityFalloff", target: "first .edge", properties: ["opacity"], allowedRenderChanges: ["firstAlpha"], allowedCouplings: ["edgeOpacity"] },
  { effectId: "massage-lab-twisted-cubes", label: "Relative outline thickness", key: "massageLabTwistedCubesOutlineThickness", target: "first .edge", properties: ["height"], allowedRenderChanges: ["firstOutlineThickness"], allowedCouplings: ["edgeHeight"] },
