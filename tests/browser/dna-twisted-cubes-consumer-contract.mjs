...
export const COMPUTED_CONSUMER_CONTRACTS = Object.freeze([
  ...
  { effectId: "massage-lab-twisted-cubes", label: "Scale", key: "massageLabTwistedCubesScale", target: "inner cube faces", properties: ["size", "transform"], allowedCouplings: ["cubeTransform", "faceWidth", "faceHeight"] },
