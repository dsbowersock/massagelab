...
export const COMPUTED_CONSUMER_CONTRACTS = Object.freeze([
  ...
  { effectId: "massage-lab-twisted-cubes", label: "Layer depth", key: "massageLabTwistedCubesLayerDepthSpacing", target: ".layer > .view", properties: ["transform", "projectedPosition"], allowedRenderChanges: ["secondDepth"], allowedCouplings: ["viewTransform", "secondViewTransform"] },
