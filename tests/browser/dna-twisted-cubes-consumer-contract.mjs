...
export const COMPUTED_CONSUMER_CONTRACTS = Object.freeze([
  ...
  { effectId: "massage-lab-twisted-cubes", label: "Scale", key: "massageLabTwistedCubesScale", target: "cube wireframe edges", properties: ["size", "transform"], allowedRenderChanges: ["scale", "firstSize"], allowedCouplings: ["cubeTransform", "edgeWidth", "edgeHeight"] },
