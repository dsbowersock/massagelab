...
/**
 * @param {ReturnType<typeof createObservableStreamsR2UploadPlan>} uploadPlan
 */
function printPlan(uploadPlan) {
  console.log(`Observable Streams R2 upload plan: ${uploadPlan.objectCount} objects`)
  console.log(`Bucket: ${uploadPlan.bucket}`)
  console.log(`Object prefix: ${uploadPlan.objectPrefix}`)
