      ...
      <div className="relative z-10 mx-auto max-w-5xl">
        {!isTimerActive ? (
          ...
          <RunningTimer
            ...
            reactBitsSideRaysPaletteMode={settings.reactBitsSideRaysPaletteMode}
            reactBitsSideRaysPrimaryColor={settings.reactBitsSideRaysPrimaryColor}
            reactBitsSideRaysHarmony={settings.reactBitsSideRaysHarmony}
            reactBitsSideRaysColorOne={settings.reactBitsSideRaysColorOne}
            reactBitsSideRaysColorTwo={settings.reactBitsSideRaysColorTwo}
            reactBitsSideRaysSpeed={settings.reactBitsSideRaysSpeed}
            reactBitsSideRaysIntensity={settings.reactBitsSideRaysIntensity}
            reactBitsSideRaysSpread={settings.reactBitsSideRaysSpread}
            reactBitsSideRaysOrigin={settings.reactBitsSideRaysOrigin}
            reactBitsSideRaysTilt={settings.reactBitsSideRaysTilt}
            reactBitsSideRaysSaturation={settings.reactBitsSideRaysSaturation}
            reactBitsSideRaysBlend={settings.reactBitsSideRaysBlend}
            reactBitsSideRaysFalloff={settings.reactBitsSideRaysFalloff}
            reactBitsSideRaysOpacity={settings.reactBitsSideRaysOpacity}
            reactBitsLightRaysPaletteMode={settings.reactBitsLightRaysPaletteMode}
            reactBitsLightRaysPrimaryColor={settings.reactBitsLightRaysPrimaryColor}
            reactBitsLightRaysHarmony={settings.reactBitsLightRaysHarmony}
            reactBitsLightRaysColor={settings.reactBitsLightRaysColor}
            reactBitsLightRaysOrigin={settings.reactBitsLightRaysOrigin}
            reactBitsLightRaysSpeed={settings.reactBitsLightRaysSpeed}
            reactBitsLightRaysSpread={settings.reactBitsLightRaysSpread}
            reactBitsLightRaysLength={settings.reactBitsLightRaysLength}
            reactBitsLightRaysPulsating={settings.reactBitsLightRaysPulsating}
            reactBitsLightRaysFadeDistance={settings.reactBitsLightRaysFadeDistance}
            reactBitsLightRaysSaturation={settings.reactBitsLightRaysSaturation}
            reactBitsLightRaysFollowMouse={settings.reactBitsLightRaysFollowMouse}
            reactBitsLightRaysMouseInfluence={settings.reactBitsLightRaysMouseInfluence}
            reactBitsLightRaysNoiseAmount={settings.reactBitsLightRaysNoiseAmount}
            reactBitsLightRaysDistortion={settings.reactBitsLightRaysDistortion}
            reactBitsPixelBlastPaletteMode={settings.reactBitsPixelBlastPaletteMode}
            reactBitsPixelBlastPrimaryColor={settings.reactBitsPixelBlastPrimaryColor}
            reactBitsPixelBlastHarmony={settings.reactBitsPixelBlastHarmony}
            reactBitsPixelBlastColor={settings.reactBitsPixelBlastColor}
            reactBitsPixelBlastVariant={settings.reactBitsPixelBlastVariant}
            reactBitsPixelBlastPixelSize={settings.reactBitsPixelBlastPixelSize}
            reactBitsPixelBlastAntialias={settings.reactBitsPixelBlastAntialias}
            reactBitsPixelBlastPatternScale={settings.reactBitsPixelBlastPatternScale}
            reactBitsPixelBlastPatternDensity={settings.reactBitsPixelBlastPatternDensity}
            reactBitsPixelBlastLiquid={settings.reactBitsPixelBlastLiquid}
            reactBitsPixelBlastLiquidStrength={settings.reactBitsPixelBlastLiquidStrength}
            reactBitsPixelBlastLiquidRadius={settings.reactBitsPixelBlastLiquidRadius}
            reactBitsPixelBlastPixelSizeJitter={settings.reactBitsPixelBlastPixelSizeJitter}
            reactBitsPixelBlastEnableRipples={settings.reactBitsPixelBlastEnableRipples}
            reactBitsPixelBlastRippleIntensityScale={settings.reactBitsPixelBlastRippleIntensityScale}
            reactBitsPixelBlastRippleThickness={settings.reactBitsPixelBlastRippleThickness}
            reactBitsPixelBlastRippleSpeed={settings.reactBitsPixelBlastRippleSpeed}
            reactBitsPixelBlastLiquidWobbleSpeed={settings.reactBitsPixelBlastLiquidWobbleSpeed}
            reactBitsPixelBlastAutoPauseOffscreen={settings.reactBitsPixelBlastAutoPauseOffscreen}
            reactBitsPixelBlastSpeed={settings.reactBitsPixelBlastSpeed}
            reactBitsPixelBlastTransparent={settings.reactBitsPixelBlastTransparent}
            reactBitsPixelBlastEdgeFade={settings.reactBitsPixelBlastEdgeFade}
            reactBitsPixelBlastNoiseAmount={settings.reactBitsPixelBlastNoiseAmount}
            reactBitsColorBendsPaletteMode={settings.reactBitsColorBendsPaletteMode}
            reactBitsColorBendsPrimaryColor={settings.reactBitsColorBendsPrimaryColor}
            reactBitsColorBendsHarmony={settings.reactBitsColorBendsHarmony}
            reactBitsColorBendsColorOne={settings.reactBitsColorBendsColorOne}
            reactBitsColorBendsColorTwo={settings.reactBitsColorBendsColorTwo}
            reactBitsColorBendsColorThree={settings.reactBitsColorBendsColorThree}
            reactBitsColorBendsColorFour={settings.reactBitsColorBendsColorFour}
            reactBitsColorBendsRotation={settings.reactBitsColorBendsRotation}
            reactBitsColorBendsSpeed={settings.reactBitsColorBendsSpeed}
            reactBitsColorBendsTransparent={settings.reactBitsColorBendsTransparent}
            reactBitsColorBendsAutoRotate={settings.reactBitsColorBendsAutoRotate}
            reactBitsColorBendsScale={settings.reactBitsColorBendsScale}
            reactBitsColorBendsFrequency={settings.reactBitsColorBendsFrequency}
            reactBitsColorBendsWarpStrength={settings.reactBitsColorBendsWarpStrength}
            reactBitsColorBendsInteractive={settings.reactBitsColorBendsInteractive}
            reactBitsColorBendsMouseInfluence={settings.reactBitsColorBendsMouseInfluence}
            reactBitsColorBendsParallax={settings.reactBitsColorBendsParallax}
            reactBitsColorBendsNoise={settings.reactBitsColorBendsNoise}
            reactBitsColorBendsIterations={settings.reactBitsColorBendsIterations}
            reactBitsColorBendsIntensity={settings.reactBitsColorBendsIntensity}
            reactBitsColorBendsBandWidth={settings.reactBitsColorBendsBandWidth}
            reactBitsEvilEyePaletteMode={settings.reactBitsEvilEyePaletteMode}
            reactBitsEvilEyePrimaryColor={settings.reactBitsEvilEyePrimaryColor}
            reactBitsEvilEyeHarmony={settings.reactBitsEvilEyeHarmony}
            reactBitsEvilEyeColor={settings.reactBitsEvilEyeColor}
            reactBitsEvilEyeBackgroundColor={settings.reactBitsEvilEyeBackgroundColor}
            reactBitsEvilEyeIntensity={settings.reactBitsEvilEyeIntensity}
            reactBitsEvilEyePupilSize={settings.reactBitsEvilEyePupilSize}
            reactBitsEvilEyeIrisWidth={settings.reactBitsEvilEyeIrisWidth}
            reactBitsEvilEyeGlowIntensity={settings.reactBitsEvilEyeGlowIntensity}
            reactBitsEvilEyeScale={settings.reactBitsEvilEyeScale}
            reactBitsEvilEyeNoiseScale={settings.reactBitsEvilEyeNoiseScale}
            reactBitsEvilEyePupilFollow={settings.reactBitsEvilEyePupilFollow}
            reactBitsEvilEyeFlameSpeed={settings.reactBitsEvilEyeFlameSpeed}
            reactBitsEvilEyeInteractive={settings.reactBitsEvilEyeInteractive}
            reactBitsLineWavesPaletteMode={settings.reactBitsLineWavesPaletteMode}
            reactBitsLineWavesPrimaryColor={settings.reactBitsLineWavesPrimaryColor}
            reactBitsLineWavesHarmony={settings.reactBitsLineWavesHarmony}
            reactBitsLineWavesColorOne={settings.reactBitsLineWavesColorOne}
            reactBitsLineWavesColorTwo={settings.reactBitsLineWavesColorTwo}
            reactBitsLineWavesColorThree={settings.reactBitsLineWavesColorThree}
            reactBitsLineWavesSpeed={settings.reactBitsLineWavesSpeed}
            reactBitsLineWavesInnerLineCount={settings.reactBitsLineWavesInnerLineCount}
            reactBitsLineWavesOuterLineCount={settings.reactBitsLineWavesOuterLineCount}
            reactBitsLineWavesWarpIntensity={settings.reactBitsLineWavesWarpIntensity}
            reactBitsLineWavesRotation={settings.reactBitsLineWavesRotation}
            reactBitsLineWavesEdgeFadeWidth={settings.reactBitsLineWavesEdgeFadeWidth}
            reactBitsLineWavesColorCycleSpeed={settings.reactBitsLineWavesColorCycleSpeed}
            reactBitsLineWavesBrightness={settings.reactBitsLineWavesBrightness}
            reactBitsLineWavesEnableMouseInteraction={settings.reactBitsLineWavesEnableMouseInteraction}
            reactBitsLineWavesMouseInfluence={settings.reactBitsLineWavesMouseInfluence}
            reactBitsRadarPaletteMode={settings.reactBitsRadarPaletteMode}
            reactBitsRadarPrimaryColor={settings.reactBitsRadarPrimaryColor}
            reactBitsRadarHarmony={settings.reactBitsRadarHarmony}
            reactBitsRadarColor={settings.reactBitsRadarColor}
            reactBitsRadarBackgroundColor={settings.reactBitsRadarBackgroundColor}
            reactBitsRadarSpeed={settings.reactBitsRadarSpeed}
            reactBitsRadarScale={settings.reactBitsRadarScale}
            reactBitsRadarRingCount={settings.reactBitsRadarRingCount}
            reactBitsRadarSpokeCount={settings.reactBitsRadarSpokeCount}
            reactBitsRadarRingThickness={settings.reactBitsRadarRingThickness}
            reactBitsRadarSpokeThickness={settings.reactBitsRadarSpokeThickness}
            reactBitsRadarSweepSpeed={settings.reactBitsRadarSweepSpeed}
            reactBitsRadarSweepWidth={settings.reactBitsRadarSweepWidth}
            reactBitsRadarSweepLobes={settings.reactBitsRadarSweepLobes}
            reactBitsRadarFalloff={settings.reactBitsRadarFalloff}
            reactBitsRadarBrightness={settings.reactBitsRadarBrightness}
            reactBitsRadarEnableMouseInteraction={settings.reactBitsRadarEnableMouseInteraction}
            reactBitsRadarMouseInfluence={settings.reactBitsRadarMouseInfluence}
            reactBitsSoftAuroraPaletteMode={settings.reactBitsSoftAuroraPaletteMode}
            reactBitsSoftAuroraPrimaryColor={settings.reactBitsSoftAuroraPrimaryColor}
            reactBitsSoftAuroraHarmony={settings.reactBitsSoftAuroraHarmony}
            reactBitsSoftAuroraColorOne={settings.reactBitsSoftAuroraColorOne}
            reactBitsSoftAuroraColorTwo={settings.reactBitsSoftAuroraColorTwo}
            reactBitsSoftAuroraSpeed={settings.reactBitsSoftAuroraSpeed}
            reactBitsSoftAuroraScale={settings.reactBitsSoftAuroraScale}
            reactBitsSoftAuroraBrightness={settings.reactBitsSoftAuroraBrightness}
            reactBitsSoftAuroraNoiseFrequency={settings.reactBitsSoftAuroraNoiseFrequency}
            reactBitsSoftAuroraNoiseAmplitude={settings.reactBitsSoftAuroraNoiseAmplitude}
            reactBitsSoftAuroraBandHeight={settings.reactBitsSoftAuroraBandHeight}
            reactBitsSoftAuroraBandSpread={settings.reactBitsSoftAuroraBandSpread}
            reactBitsSoftAuroraOctaveDecay={settings.reactBitsSoftAuroraOctaveDecay}
            reactBitsSoftAuroraLayerOffset={settings.reactBitsSoftAuroraLayerOffset}
            ...
            reactBitsPlasmaWavePaletteMode={settings.reactBitsPlasmaWavePaletteMode}
            reactBitsPlasmaWavePrimaryColor={settings.reactBitsPlasmaWavePrimaryColor}
            reactBitsPlasmaWaveHarmony={settings.reactBitsPlasmaWaveHarmony}
            reactBitsPlasmaWaveColorOne={settings.reactBitsPlasmaWaveColorOne}
            reactBitsPlasmaWaveColorTwo={settings.reactBitsPlasmaWaveColorTwo}
            reactBitsPlasmaWaveXOffset={settings.reactBitsPlasmaWaveXOffset}
            reactBitsPlasmaWaveYOffset={settings.reactBitsPlasmaWaveYOffset}
            reactBitsPlasmaWaveRotationDeg={settings.reactBitsPlasmaWaveRotationDeg}
            reactBitsPlasmaWaveFocalLength={settings.reactBitsPlasmaWaveFocalLength}
            reactBitsPlasmaWaveSpeedOne={settings.reactBitsPlasmaWaveSpeedOne}
            reactBitsPlasmaWaveSpeedTwo={settings.reactBitsPlasmaWaveSpeedTwo}
            reactBitsPlasmaWaveDirectionTwo={settings.reactBitsPlasmaWaveDirectionTwo}
            reactBitsPlasmaWaveBendOne={settings.reactBitsPlasmaWaveBendOne}
            reactBitsPlasmaWaveBendTwo={settings.reactBitsPlasmaWaveBendTwo}
            reactBitsParticlesPaletteMode={settings.reactBitsParticlesPaletteMode}
            reactBitsParticlesPrimaryColor={settings.reactBitsParticlesPrimaryColor}
            reactBitsParticlesHarmony={settings.reactBitsParticlesHarmony}
            reactBitsParticlesColorOne={settings.reactBitsParticlesColorOne}
            reactBitsParticlesColorTwo={settings.reactBitsParticlesColorTwo}
            reactBitsParticlesColorThree={settings.reactBitsParticlesColorThree}
            reactBitsParticlesCount={settings.reactBitsParticlesCount}
            reactBitsParticlesSpread={settings.reactBitsParticlesSpread}
            reactBitsParticlesSpeed={settings.reactBitsParticlesSpeed}
            reactBitsParticlesMoveOnHover={settings.reactBitsParticlesMoveOnHover}
            reactBitsParticlesHoverFactor={settings.reactBitsParticlesHoverFactor}
            reactBitsParticlesAlpha={settings.reactBitsParticlesAlpha}
            reactBitsParticlesBaseSize={settings.reactBitsParticlesBaseSize}
            reactBitsParticlesSizeRandomness={settings.reactBitsParticlesSizeRandomness}
            reactBitsParticlesCameraDistance={settings.reactBitsParticlesCameraDistance}
            reactBitsParticlesDisableRotation={settings.reactBitsParticlesDisableRotation}
            reactBitsParticlesPixelRatio={settings.reactBitsParticlesPixelRatio}
            reactBitsGradientBlindsPaletteMode={settings.reactBitsGradientBlindsPaletteMode}
            reactBitsGradientBlindsPrimaryColor={settings.reactBitsGradientBlindsPrimaryColor}
            reactBitsGradientBlindsHarmony={settings.reactBitsGradientBlindsHarmony}
            reactBitsGradientBlindsColorOne={settings.reactBitsGradientBlindsColorOne}
            reactBitsGradientBlindsColorTwo={settings.reactBitsGradientBlindsColorTwo}
            reactBitsGradientBlindsAngle={settings.reactBitsGradientBlindsAngle}
            reactBitsGradientBlindsNoise={settings.reactBitsGradientBlindsNoise}
            reactBitsGradientBlindsBlindCount={settings.reactBitsGradientBlindsBlindCount}
            reactBitsGradientBlindsBlindMinWidth={settings.reactBitsGradientBlindsBlindMinWidth}
            reactBitsGradientBlindsMouseDampening={settings.reactBitsGradientBlindsMouseDampening}
            reactBitsGradientBlindsMirror={settings.reactBitsGradientBlindsMirror}
            reactBitsGradientBlindsSpotlightRadius={settings.reactBitsGradientBlindsSpotlightRadius}
            reactBitsGradientBlindsSpotlightSoftness={settings.reactBitsGradientBlindsSpotlightSoftness}
            reactBitsGradientBlindsSpotlightOpacity={settings.reactBitsGradientBlindsSpotlightOpacity}
            reactBitsGradientBlindsDistort={settings.reactBitsGradientBlindsDistort}
            reactBitsGradientBlindsShineDirection={settings.reactBitsGradientBlindsShineDirection}
            reactBitsGradientBlindsBlendMode={settings.reactBitsGradientBlindsBlendMode}
            reactBitsGradientBlindsDpr={settings.reactBitsGradientBlindsDpr}
            reactBitsGradientBlindsEnableMouseInteraction={settings.reactBitsGradientBlindsEnableMouseInteraction}
            reactBitsGrainientPaletteMode={settings.reactBitsGrainientPaletteMode}
            reactBitsGrainientPrimaryColor={settings.reactBitsGrainientPrimaryColor}
            reactBitsGrainientHarmony={settings.reactBitsGrainientHarmony}
            reactBitsGrainientColorOne={settings.reactBitsGrainientColorOne}
            reactBitsGrainientColorTwo={settings.reactBitsGrainientColorTwo}
            reactBitsGrainientColorThree={settings.reactBitsGrainientColorThree}
            reactBitsGrainientTimeSpeed={settings.reactBitsGrainientTimeSpeed}
            reactBitsGrainientColorBalance={settings.reactBitsGrainientColorBalance}
            reactBitsGrainientWarpStrength={settings.reactBitsGrainientWarpStrength}
            reactBitsGrainientWarpFrequency={settings.reactBitsGrainientWarpFrequency}
            reactBitsGrainientWarpSpeed={settings.reactBitsGrainientWarpSpeed}
            reactBitsGrainientWarpAmplitude={settings.reactBitsGrainientWarpAmplitude}
            reactBitsGrainientBlendAngle={settings.reactBitsGrainientBlendAngle}
            reactBitsGrainientBlendSoftness={settings.reactBitsGrainientBlendSoftness}
            reactBitsGrainientRotationAmount={settings.reactBitsGrainientRotationAmount}
            reactBitsGrainientNoiseScale={settings.reactBitsGrainientNoiseScale}
            reactBitsGrainientGrainAmount={settings.reactBitsGrainientGrainAmount}
            reactBitsGrainientGrainScale={settings.reactBitsGrainientGrainScale}
            reactBitsGrainientGrainAnimated={settings.reactBitsGrainientGrainAnimated}
            reactBitsGrainientContrast={settings.reactBitsGrainientContrast}
            reactBitsGrainientGamma={settings.reactBitsGrainientGamma}
            reactBitsGrainientSaturation={settings.reactBitsGrainientSaturation}
            reactBitsGrainientCenterX={settings.reactBitsGrainientCenterX}
            reactBitsGrainientCenterY={settings.reactBitsGrainientCenterY}
            reactBitsGrainientZoom={settings.reactBitsGrainientZoom}
            reactBitsGridScanPaletteMode={settings.reactBitsGridScanPaletteMode}
            reactBitsGridScanPrimaryColor={settings.reactBitsGridScanPrimaryColor}
            reactBitsGridScanHarmony={settings.reactBitsGridScanHarmony}
            reactBitsGridScanLinesColor={settings.reactBitsGridScanLinesColor}
            reactBitsGridScanScanColor={settings.reactBitsGridScanScanColor}
            reactBitsGridScanSensitivity={settings.reactBitsGridScanSensitivity}
            reactBitsGridScanLineThickness={settings.reactBitsGridScanLineThickness}
            reactBitsGridScanScanOpacity={settings.reactBitsGridScanScanOpacity}
            reactBitsGridScanGridScale={settings.reactBitsGridScanGridScale}
            reactBitsGridScanLineStyle={settings.reactBitsGridScanLineStyle}
            reactBitsGridScanLineJitter={settings.reactBitsGridScanLineJitter}
            reactBitsGridScanDirection={settings.reactBitsGridScanDirection}
            reactBitsGridScanNoiseIntensity={settings.reactBitsGridScanNoiseIntensity}
            reactBitsGridScanBloomOpacity={settings.reactBitsGridScanBloomOpacity}
            reactBitsGridScanScanGlow={settings.reactBitsGridScanScanGlow}
            reactBitsGridScanScanSoftness={settings.reactBitsGridScanScanSoftness}
            reactBitsGridScanPhaseTaper={settings.reactBitsGridScanPhaseTaper}
            reactBitsGridScanScanDuration={settings.reactBitsGridScanScanDuration}
            ...
            reactBitsPixelSnowPaletteMode={settings.reactBitsPixelSnowPaletteMode}
            reactBitsPixelSnowPrimaryColor={settings.reactBitsPixelSnowPrimaryColor}
            reactBitsPixelSnowHarmony={settings.reactBitsPixelSnowHarmony}
            reactBitsPixelSnowColor={settings.reactBitsPixelSnowColor}
            reactBitsPixelSnowFlakeSize={settings.reactBitsPixelSnowFlakeSize}
            reactBitsPixelSnowMinFlakeSize={settings.reactBitsPixelSnowMinFlakeSize}
            reactBitsPixelSnowPixelResolution={settings.reactBitsPixelSnowPixelResolution}
            reactBitsPixelSnowSpeed={settings.reactBitsPixelSnowSpeed}
            reactBitsPixelSnowDepthFade={settings.reactBitsPixelSnowDepthFade}
            reactBitsPixelSnowFarPlane={settings.reactBitsPixelSnowFarPlane}
            reactBitsPixelSnowBrightness={settings.reactBitsPixelSnowBrightness}
            reactBitsPixelSnowGamma={settings.reactBitsPixelSnowGamma}
            ...
            reactBitsPrismaticBurstPaletteMode={settings.reactBitsPrismaticBurstPaletteMode}
            reactBitsPrismaticBurstPrimaryColor={settings.reactBitsPrismaticBurstPrimaryColor}
            reactBitsPrismaticBurstHarmony={settings.reactBitsPrismaticBurstHarmony}
            reactBitsPrismaticBurstColorOne={settings.reactBitsPrismaticBurstColorOne}
            reactBitsPrismaticBurstColorTwo={settings.reactBitsPrismaticBurstColorTwo}
            reactBitsPrismaticBurstColorThree={settings.reactBitsPrismaticBurstColorThree}
            reactBitsPrismaticBurstColorFour={settings.reactBitsPrismaticBurstColorFour}
            reactBitsPrismaticBurstIntensity={settings.reactBitsPrismaticBurstIntensity}
            reactBitsPrismaticBurstSpeed={settings.reactBitsPrismaticBurstSpeed}
            reactBitsPrismaticBurstAnimationType={settings.reactBitsPrismaticBurstAnimationType}
            reactBitsPrismaticBurstDistort={settings.reactBitsPrismaticBurstDistort}
            reactBitsPrismaticBurstOffsetX={settings.reactBitsPrismaticBurstOffsetX}
            reactBitsPrismaticBurstOffsetY={settings.reactBitsPrismaticBurstOffsetY}
            reactBitsPrismaticBurstHoverDampness={settings.reactBitsPrismaticBurstHoverDampness}
            reactBitsPrismaticBurstRayCount={settings.reactBitsPrismaticBurstRayCount}
            reactBitsPrismaticBurstMixBlendMode={settings.reactBitsPrismaticBurstMixBlendMode}
            reactBitsGalaxyPaletteMode={settings.reactBitsGalaxyPaletteMode}
            reactBitsGalaxyPrimaryColor={settings.reactBitsGalaxyPrimaryColor}
            reactBitsGalaxyHarmony={settings.reactBitsGalaxyHarmony}
            reactBitsGalaxyColor={settings.reactBitsGalaxyColor}
            reactBitsGalaxyHueShift={settings.reactBitsGalaxyHueShift}
            reactBitsGalaxyFocalX={settings.reactBitsGalaxyFocalX}
            reactBitsGalaxyFocalY={settings.reactBitsGalaxyFocalY}
            reactBitsGalaxyRotationDeg={settings.reactBitsGalaxyRotationDeg}
            reactBitsGalaxyStarSpeed={settings.reactBitsGalaxyStarSpeed}
            reactBitsGalaxyDensity={settings.reactBitsGalaxyDensity}
            reactBitsGalaxySpeed={settings.reactBitsGalaxySpeed}
            reactBitsGalaxyMouseInteraction={settings.reactBitsGalaxyMouseInteraction}
            reactBitsGalaxyGlowIntensity={settings.reactBitsGalaxyGlowIntensity}
            reactBitsGalaxySaturation={settings.reactBitsGalaxySaturation}
            reactBitsGalaxyMouseRepulsion={settings.reactBitsGalaxyMouseRepulsion}
            reactBitsGalaxyRepulsionStrength={settings.reactBitsGalaxyRepulsionStrength}
            reactBitsGalaxyTwinkleIntensity={settings.reactBitsGalaxyTwinkleIntensity}
            ...
            reactBitsFaultyTerminalPaletteMode={settings.reactBitsFaultyTerminalPaletteMode}
            reactBitsFaultyTerminalPrimaryColor={settings.reactBitsFaultyTerminalPrimaryColor}
            reactBitsFaultyTerminalHarmony={settings.reactBitsFaultyTerminalHarmony}
            reactBitsFaultyTerminalTint={settings.reactBitsFaultyTerminalTint}
            reactBitsFaultyTerminalScale={settings.reactBitsFaultyTerminalScale}
            reactBitsFaultyTerminalGridMulX={settings.reactBitsFaultyTerminalGridMulX}
            reactBitsFaultyTerminalGridMulY={settings.reactBitsFaultyTerminalGridMulY}
            reactBitsFaultyTerminalDigitSize={settings.reactBitsFaultyTerminalDigitSize}
            reactBitsFaultyTerminalTimeScale={settings.reactBitsFaultyTerminalTimeScale}
            reactBitsFaultyTerminalScanlineIntensity={settings.reactBitsFaultyTerminalScanlineIntensity}
            reactBitsFaultyTerminalGlitchAmount={settings.reactBitsFaultyTerminalGlitchAmount}
            reactBitsFaultyTerminalFlickerAmount={settings.reactBitsFaultyTerminalFlickerAmount}
            reactBitsFaultyTerminalNoiseAmp={settings.reactBitsFaultyTerminalNoiseAmp}
            reactBitsFaultyTerminalChromaticAberration={settings.reactBitsFaultyTerminalChromaticAberration}
            reactBitsFaultyTerminalDither={settings.reactBitsFaultyTerminalDither}
            reactBitsFaultyTerminalCurvature={settings.reactBitsFaultyTerminalCurvature}
            reactBitsFaultyTerminalMouseReact={settings.reactBitsFaultyTerminalMouseReact}
            reactBitsFaultyTerminalMouseStrength={settings.reactBitsFaultyTerminalMouseStrength}
            reactBitsFaultyTerminalPageLoadAnimation={settings.reactBitsFaultyTerminalPageLoadAnimation}
            reactBitsFaultyTerminalBrightness={settings.reactBitsFaultyTerminalBrightness}
            reactBitsRippleGridPaletteMode={settings.reactBitsRippleGridPaletteMode}
            reactBitsRippleGridPrimaryColor={settings.reactBitsRippleGridPrimaryColor}
            reactBitsRippleGridHarmony={settings.reactBitsRippleGridHarmony}
            reactBitsRippleGridColor={settings.reactBitsRippleGridColor}
            reactBitsRippleGridRippleIntensity={settings.reactBitsRippleGridRippleIntensity}
            reactBitsRippleGridGridSize={settings.reactBitsRippleGridGridSize}
            reactBitsRippleGridGridThickness={settings.reactBitsRippleGridGridThickness}
            reactBitsRippleGridFadeDistance={settings.reactBitsRippleGridFadeDistance}
            reactBitsRippleGridVignetteStrength={settings.reactBitsRippleGridVignetteStrength}
            reactBitsRippleGridGlowIntensity={settings.reactBitsRippleGridGlowIntensity}
            reactBitsRippleGridOpacity={settings.reactBitsRippleGridOpacity}
            reactBitsRippleGridGridRotation={settings.reactBitsRippleGridGridRotation}
            reactBitsRippleGridMouseInteraction={settings.reactBitsRippleGridMouseInteraction}
            reactBitsRippleGridMouseInteractionRadius={settings.reactBitsRippleGridMouseInteractionRadius}
            reactBitsDotFieldPaletteMode={settings.reactBitsDotFieldPaletteMode}
            reactBitsDotFieldPrimaryColor={settings.reactBitsDotFieldPrimaryColor}
            reactBitsDotFieldHarmony={settings.reactBitsDotFieldHarmony}
            reactBitsDotFieldGradientFromColor={settings.reactBitsDotFieldGradientFromColor}
            reactBitsDotFieldGradientFromAlpha={settings.reactBitsDotFieldGradientFromAlpha}
            reactBitsDotFieldGradientToColor={settings.reactBitsDotFieldGradientToColor}
            reactBitsDotFieldGradientToAlpha={settings.reactBitsDotFieldGradientToAlpha}
            reactBitsDotFieldGlowColor={settings.reactBitsDotFieldGlowColor}
            reactBitsDotFieldDotRadius={settings.reactBitsDotFieldDotRadius}
            reactBitsDotFieldDotSpacing={settings.reactBitsDotFieldDotSpacing}
            reactBitsDotFieldCursorRadius={settings.reactBitsDotFieldCursorRadius}
            reactBitsDotFieldCursorForce={settings.reactBitsDotFieldCursorForce}
            reactBitsDotFieldBulgeOnly={settings.reactBitsDotFieldBulgeOnly}
            reactBitsDotFieldBulgeStrength={settings.reactBitsDotFieldBulgeStrength}
            reactBitsDotFieldGlowRadius={settings.reactBitsDotFieldGlowRadius}
            reactBitsDotFieldSparkle={settings.reactBitsDotFieldSparkle}
            reactBitsDotFieldWaveAmplitude={settings.reactBitsDotFieldWaveAmplitude}
            reactBitsDotFieldCursorInteraction={settings.reactBitsDotFieldCursorInteraction}
            reactBitsDotGridPaletteMode={settings.reactBitsDotGridPaletteMode}
            reactBitsDotGridPrimaryColor={settings.reactBitsDotGridPrimaryColor}
            reactBitsDotGridHarmony={settings.reactBitsDotGridHarmony}
            reactBitsDotGridBaseColor={settings.reactBitsDotGridBaseColor}
            reactBitsDotGridActiveColor={settings.reactBitsDotGridActiveColor}
            reactBitsDotGridDotSize={settings.reactBitsDotGridDotSize}
            reactBitsDotGridGap={settings.reactBitsDotGridGap}
            reactBitsDotGridProximity={settings.reactBitsDotGridProximity}
            reactBitsDotGridSpeedTrigger={settings.reactBitsDotGridSpeedTrigger}
            reactBitsDotGridShockRadius={settings.reactBitsDotGridShockRadius}
            reactBitsDotGridShockStrength={settings.reactBitsDotGridShockStrength}
            reactBitsDotGridMaxSpeed={settings.reactBitsDotGridMaxSpeed}
            reactBitsDotGridResistance={settings.reactBitsDotGridResistance}
            reactBitsDotGridReturnDuration={settings.reactBitsDotGridReturnDuration}
            reactBitsDotGridCursorInteraction={settings.reactBitsDotGridCursorInteraction}
            reactBitsDotGridClickShock={settings.reactBitsDotGridClickShock}
            reactBitsThreadsPaletteMode={settings.reactBitsThreadsPaletteMode}
            reactBitsThreadsPrimaryColor={settings.reactBitsThreadsPrimaryColor}
            reactBitsThreadsHarmony={settings.reactBitsThreadsHarmony}
            reactBitsThreadsColor={settings.reactBitsThreadsColor}
            reactBitsThreadsAmplitude={settings.reactBitsThreadsAmplitude}
            reactBitsThreadsDistance={settings.reactBitsThreadsDistance}
            reactBitsThreadsEnableMouseInteraction={settings.reactBitsThreadsEnableMouseInteraction}
            reactBitsIridescencePaletteMode={settings.reactBitsIridescencePaletteMode}
            reactBitsIridescencePrimaryColor={settings.reactBitsIridescencePrimaryColor}
            reactBitsIridescenceHarmony={settings.reactBitsIridescenceHarmony}
            reactBitsIridescenceColor={settings.reactBitsIridescenceColor}
            reactBitsIridescenceSpeed={settings.reactBitsIridescenceSpeed}
            reactBitsIridescenceAmplitude={settings.reactBitsIridescenceAmplitude}
            reactBitsIridescenceMouseReact={settings.reactBitsIridescenceMouseReact}
            reactBitsWavesPaletteMode={settings.reactBitsWavesPaletteMode}
            reactBitsWavesPrimaryColor={settings.reactBitsWavesPrimaryColor}
            reactBitsWavesHarmony={settings.reactBitsWavesHarmony}
            reactBitsWavesLineColor={settings.reactBitsWavesLineColor}
            reactBitsWavesBackgroundColor={settings.reactBitsWavesBackgroundColor}
            reactBitsWavesTransparentBackground={settings.reactBitsWavesTransparentBackground}
            reactBitsWavesSpeedX={settings.reactBitsWavesSpeedX}
            reactBitsWavesSpeedY={settings.reactBitsWavesSpeedY}
            reactBitsWavesAmplitudeX={settings.reactBitsWavesAmplitudeX}
            reactBitsWavesAmplitudeY={settings.reactBitsWavesAmplitudeY}
            reactBitsWavesGapX={settings.reactBitsWavesGapX}
            reactBitsWavesGapY={settings.reactBitsWavesGapY}
            reactBitsWavesFriction={settings.reactBitsWavesFriction}
            ...
            reactBitsOrbPaletteMode={settings.reactBitsOrbPaletteMode}
            reactBitsOrbPrimaryColor={settings.reactBitsOrbPrimaryColor}
            reactBitsOrbHarmony={settings.reactBitsOrbHarmony}
            reactBitsOrbColor={settings.reactBitsOrbColor}
            reactBitsOrbHue={settings.reactBitsOrbHue}
            reactBitsOrbHoverIntensity={settings.reactBitsOrbHoverIntensity}
            reactBitsOrbRotateOnHover={settings.reactBitsOrbRotateOnHover}
            reactBitsOrbForceHoverState={settings.reactBitsOrbForceHoverState}
            reactBitsOrbBackgroundColor={settings.reactBitsOrbBackgroundColor}
            reactBitsOrbCursorInteraction={settings.reactBitsOrbCursorInteraction}
            reactBitsLetterGlitchPaletteMode={settings.reactBitsLetterGlitchPaletteMode}
            reactBitsLetterGlitchPrimaryColor={settings.reactBitsLetterGlitchPrimaryColor}
            reactBitsLetterGlitchHarmony={settings.reactBitsLetterGlitchHarmony}
            reactBitsLetterGlitchColorOne={settings.reactBitsLetterGlitchColorOne}
            reactBitsLetterGlitchColorTwo={settings.reactBitsLetterGlitchColorTwo}
            reactBitsLetterGlitchColorThree={settings.reactBitsLetterGlitchColorThree}
            reactBitsLetterGlitchGlitchSpeed={settings.reactBitsLetterGlitchGlitchSpeed}
            reactBitsLetterGlitchCenterVignette={settings.reactBitsLetterGlitchCenterVignette}
            reactBitsLetterGlitchOuterVignette={settings.reactBitsLetterGlitchOuterVignette}
            reactBitsLetterGlitchSmooth={settings.reactBitsLetterGlitchSmooth}
            reactBitsLetterGlitchCharacters={settings.reactBitsLetterGlitchCharacters}
            reactBitsGridMotionPaletteMode={settings.reactBitsGridMotionPaletteMode}
            reactBitsGridMotionPrimaryColor={settings.reactBitsGridMotionPrimaryColor}
            reactBitsGridMotionHarmony={settings.reactBitsGridMotionHarmony}
            reactBitsGridMotionGradientColor={settings.reactBitsGridMotionGradientColor}
            reactBitsGridMotionTileColor={settings.reactBitsGridMotionTileColor}
            reactBitsGridMotionTextColor={settings.reactBitsGridMotionTextColor}
            reactBitsGridMotionMaxMoveAmount={settings.reactBitsGridMotionMaxMoveAmount}
            reactBitsGridMotionBaseDuration={settings.reactBitsGridMotionBaseDuration}
            reactBitsGridMotionCursorInteraction={settings.reactBitsGridMotionCursorInteraction}
            reactBitsShapeGridPaletteMode={settings.reactBitsShapeGridPaletteMode}
            reactBitsShapeGridPrimaryColor={settings.reactBitsShapeGridPrimaryColor}
            reactBitsShapeGridHarmony={settings.reactBitsShapeGridHarmony}
            reactBitsShapeGridBorderColor={settings.reactBitsShapeGridBorderColor}
            reactBitsShapeGridHoverFillColor={settings.reactBitsShapeGridHoverFillColor}
            reactBitsShapeGridDirection={settings.reactBitsShapeGridDirection}
            reactBitsShapeGridSpeed={settings.reactBitsShapeGridSpeed}
            reactBitsShapeGridSquareSize={settings.reactBitsShapeGridSquareSize}
            reactBitsShapeGridShape={settings.reactBitsShapeGridShape}
            reactBitsShapeGridHoverTrailAmount={settings.reactBitsShapeGridHoverTrailAmount}
            reactBitsShapeGridCursorInteraction={settings.reactBitsShapeGridCursorInteraction}
            reactBitsLiquidChromePaletteMode={settings.reactBitsLiquidChromePaletteMode}
            reactBitsLiquidChromePrimaryColor={settings.reactBitsLiquidChromePrimaryColor}
            reactBitsLiquidChromeHarmony={settings.reactBitsLiquidChromeHarmony}
            reactBitsLiquidChromeBaseColor={settings.reactBitsLiquidChromeBaseColor}
            reactBitsLiquidChromeSpeed={settings.reactBitsLiquidChromeSpeed}
            reactBitsLiquidChromeAmplitude={settings.reactBitsLiquidChromeAmplitude}
            reactBitsLiquidChromeFrequencyX={settings.reactBitsLiquidChromeFrequencyX}
            reactBitsLiquidChromeFrequencyY={settings.reactBitsLiquidChromeFrequencyY}
            reactBitsLiquidChromeInteractive={settings.reactBitsLiquidChromeInteractive}
            reactBitsBalatroPaletteMode={settings.reactBitsBalatroPaletteMode}
            reactBitsBalatroPrimaryColor={settings.reactBitsBalatroPrimaryColor}
            reactBitsBalatroHarmony={settings.reactBitsBalatroHarmony}
            reactBitsBalatroColorOne={settings.reactBitsBalatroColorOne}
            reactBitsBalatroColorTwo={settings.reactBitsBalatroColorTwo}
            reactBitsBalatroColorThree={settings.reactBitsBalatroColorThree}
            reactBitsBalatroSpinRotation={settings.reactBitsBalatroSpinRotation}
            reactBitsBalatroSpinSpeed={settings.reactBitsBalatroSpinSpeed}
            reactBitsBalatroOffsetX={settings.reactBitsBalatroOffsetX}
            reactBitsBalatroOffsetY={settings.reactBitsBalatroOffsetY}
            reactBitsBalatroContrast={settings.reactBitsBalatroContrast}
            reactBitsBalatroLighting={settings.reactBitsBalatroLighting}
            reactBitsBalatroSpinAmount={settings.reactBitsBalatroSpinAmount}
            reactBitsBalatroPixelFilter={settings.reactBitsBalatroPixelFilter}
            reactBitsBalatroSpinEase={settings.reactBitsBalatroSpinEase}
            reactBitsBalatroIsRotate={settings.reactBitsBalatroIsRotate}
            reactBitsBalatroMouseInteraction={settings.reactBitsBalatroMouseInteraction}
